/******/ (() => { // webpackBootstrap
/*!***************************************************!*\
  !*** ./src/block-cta-create-project-main/view.js ***!
  \***************************************************/
(function () {
  ...
  function initMobileStackReveal() {
    ...
    const wrapper = document.querySelector(".wp-block-blocks-smarttech-block-cta");
    ...
    function lock() {
      ...
      wrapper.style.cssText = "position:fixed; top:0; left:0; width:100%; z-index:999;";
    ...
    function unlock() {
      ...
      // Скроллим за блок
      const bottom = wrapper.getBoundingClientRect().bottom + window.pageYOffset;
      window.scrollTo({
        top: bottom,
        behavior: "instant"
      });
