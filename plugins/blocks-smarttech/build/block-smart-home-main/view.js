/******/ (() => { // webpackBootstrap
/*!*******************************************!*\
  !*** ./src/block-smart-home-main/view.js ***!
  \*******************************************/
(function () {
  ...
  function initSliders() {
    document.querySelectorAll(".smart-home__slider").forEach(slider => {
      ...
      const slides = Array.from(viewport.querySelectorAll(".smart-home__slide"));
  ...
  function initVideoPlayback() {
    document.querySelectorAll(".smart-home__play-icon").forEach(btn => {
      btn.addEventListener("click", function () {
        ...
        const rotatingText = videoBlock.querySelector(".smart-home__rotating-text");
        if (video) {
